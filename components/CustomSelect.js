...
export const MySelect = () => {
  ...
  return (
    <div className=" w-[76px] h-[58px] px-2 py-2 border-r border-blue-300 flex items-center z-50">
      <Listbox value={selectedItem} onChange={setSelectedItem}>
        <div className="relative mt-1">
          ...
          <div className="pl-0 absolute pt-2 top-[2rem] -left-[0.3rem] w-[72px] flex flex-col items-center ">
            <Listbox.Options>
              <div className="border w-[76px] rounded-md flex flex-col gap-y-1 py-2 items-center border-blue-300 bg-white">
